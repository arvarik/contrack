...
**Test Suite:** 921 tests (827 passing, 94 todo) — unit + integration (real SQLite), 0 regressions. The todos are the routes the Phase 2 isolation matrix has not reached yet, in `tests/integration/tenancy.isolation.test.ts`.
