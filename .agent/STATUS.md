...
**Test Suite:** 898 tests (787 passing, 111 todo) — unit + integration (real SQLite), 0 regressions. The todos are the Phase 2 isolation matrix in `tests/integration/tenancy.isolation.test.ts`.
