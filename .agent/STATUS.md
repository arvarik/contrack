...
**Test Suite:** 933 tests (874 passing, 59 todo) — unit + integration (real SQLite), 0 regressions. The todos are the routes the Phase 2 isolation matrix has not reached yet, in `tests/integration/tenancy.isolation.test.ts`.
