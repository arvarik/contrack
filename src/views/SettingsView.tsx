  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-surface text-on-surface">
      <header className="p-6 bg-surface-container-low shrink-0">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <button
              onClick={() =>
                isSubpage ? navigate("/settings") : navigate("/")
              }
              className={ICON_BTN}
            >
            ...
            <div>
              <h1 className={cn(PAGE_TITLE, "flex items-center gap-3")}>
                <div className="p-2 bg-primary/10 rounded-xl">{getIcon()}</div>
                {getTitle()}
              </h1>
            </div>
          </div>
      ...
      <div
        className={cn(
          "flex-1",
          isDedupe || isLists ? "overflow-hidden" : "overflow-y-auto",
        )}
      >
        <Routes>
          <Route
            ...
            element={
              <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-4">
                ...
                <div className={CARD}>
                  ...
                  >
                    ...
                    <p className="text-sm text-on-surface-variant">
                      Find and merge duplicate contacts using AI-powered
                      detection, or manually select contacts to merge.
                    </p>
                  </Link>
                  ...
                  <div className="mt-4 -mx-6 -mb-6 bg-surface-container-low rounded-b-2xl px-6 py-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex bg-surface-container rounded-full p-1 shadow-inner h-9 ml-4 shrink-0">
                        {(
                          ["conservative", "default", "aggressive"] as const
                        ).map((p) => (
                          <button
                            key={p}
                            onClick={() => setPreset(p)}
                ...
                >
                  ...
                  <p className="text-sm text-on-surface-variant">
                    Automatically research and enrich contact profiles using
                ...
                >
                  ...
                  <p className="text-sm text-on-surface-variant">
                    View historical AI invocations, token usage, cache
                    performance, and approximate costs.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-sm text-on-surface-variant">
                    Reorder, rename, and delete your contact lists. Manage which
                    contacts belong to each list.
                  </p>
                </Link>
                ...
                <section className={CARD}>
                  ...
                  <div className="flex items-center justify-between py-3">
                    <div>
                      ...
                      <p className="text-sm text-on-surface-variant">
                        Choose how weather is displayed
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-3">
                    <div>
                      ...
                      <p className="text-sm text-on-surface-variant">
                        Number of recently visited contacts shown at the top of
                        your Network. Set to 0 to hide.
                      </p>
                    </div>
                ...
                >
                  <h3
                    className={cn(
                      SECTION_HEADING,
                      "mb-2 flex items-center gap-2 group-hover:text-amber-500 transition-colors",
                    )}
                  >
                  ...
                  <p className="text-sm text-on-surface-variant">
                    View and restore contacts you've archived. Archived contacts
