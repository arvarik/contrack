...
import { CARD, SECTION_HEADING, SEARCH_INPUT, EMPTY_STATE } from '../../lib/styles';
    ...
    <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-4 pb-20">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-xl font-headline font-bold text-on-surface">AI Search</h2>
      ...
      {/* Empty state */}
      {!isLoading && filteredContacts.length === 0 && !searchQuery && dataFilter === 'all' && (
        ...
        <>
          <div className={cn(CARD, 'p-0 overflow-hidden')}>
            ...
            <div className="px-4 py-2.5 bg-surface-container-low space-y-2">
              ...
              <div className="flex gap-1.5 flex-wrap">
                {FILTERS.map(f => (
                  <button
                    key={f.id}
                    onClick={() => { setDataFilter(f.id); setSelectedIds(new Set()); }}
                    className={cn(
            ...
            <div className="max-h-[360px] overflow-y-auto nice-scrollbar">
              {filteredContacts.length === 0 && (searchQuery || dataFilter !== 'all') && (
